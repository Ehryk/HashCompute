...
{
    /// <summary>
    /// Implements a 16-bit CRC hash algorithm compatible with Zip etc.
    /// </summary>
    /// <remarks>
    ...
    {
        public const UInt16 DefaultPolynomial = (UInt16)0xA001u;
        public const UInt16 DefaultSeed = (UInt16)0x0000u;
        ...
        public CRC16(UInt16 polynomial, UInt16 seed)
        {
